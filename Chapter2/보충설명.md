...
이러한 오차 문제를 해결 하기 위해 자바스크립트에서는 에러 한계치(margin of error)를 저장하고 있습니다. 이 프로퍼티가 Number.EPSILON 입니다.

`console.log(Number.EPSILON);	//2.220446049250313e-16`

Number.EPSILON은 2^-52 의 아주 작은 숫자를 나타냅니다. 두 수의 차이(-)가 Number.EPSILON 범위 내에 있다면 같다라고 생각 할 수 있습니다. 
